  ...
  <div class="container">
    <div class="bg-white my-2 p-3">
      ...
      <div
        ...
        class="flex flex-col shadow mb-2"
      >
        ...
        <div class="flex w-full justify-between p-2">
          ...
          >
            ...
            <span
              ...
              >{{ $settings.sections.cart.buttons.back_to_shop_text }}</span
            >
          </nuxt-link>
          <a
            href="https://josuouedraogo.storeino.world/checkout2/"
            class="
              flex
              items-center
              text-2xl
      ...
      >
        ...
        <nuxt-link
          to="/shop"
          class="flex items-center p-2 justify-center bg-primary text-white"
        >
          <svg
            aria-hidden="true"
            focusable="false"
    ...
    <div
      class="flex flex-col bg-white mb-2"
      v-if="!loading.cart && items.length > 0"
    >
  ...
  methods: {
    ...
    calcTotal() {
      this.total = this.items
        .reduce((total, item) => total + item.price * item.quantity.value, 0)
        .toFixed(2);
    },
  },
};
